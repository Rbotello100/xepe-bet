...
import { getBestBetOfTheDay, getWorstBetOfTheDay } from '@/features/bets/queries'
...
export default async function HomePage({ searchParams }: HomePageProps) {
  ...
  const [feedPosts, leaderboard, bestBet, worstBet, matchCount, liveCount] = await Promise.all([
