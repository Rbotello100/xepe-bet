...
CREATE INDEX "idx_bets_status_pending" ON "public"."bets" USING "btree" ("status") WHERE ("status" = 'pending'::"text");
...
CREATE INDEX "idx_credit_tx_type_created" ON "public"."credit_transactions" USING "btree" ("type", "created_at" DESC);
...
CREATE INDEX "idx_match_markets_match_id" ON "public"."match_markets" USING "btree" ("match_id");
...
CREATE INDEX "idx_parlay_legs_match_id" ON "public"."parlay_legs" USING "btree" ("match_id");
...
CREATE INDEX "idx_parlays_status_pending" ON "public"."parlays" USING "btree" ("status") WHERE ("status" = 'pending'::"text");
...
CREATE POLICY "ai_feed_insert_block" ON "public"."ai_feed" FOR INSERT TO "authenticated", "anon" WITH CHECK (false);
...
CREATE POLICY "credit_tx_insert_block" ON "public"."credit_transactions" FOR INSERT TO "authenticated", "anon" WITH CHECK (false);
...
CREATE POLICY "special_bets_own_select" ON "public"."special_bets" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "transactions_own_select" ON "public"."transactions" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));
